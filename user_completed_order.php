...
<body>
    ...
    <div class="cart_container rounded p-2 mt-2">
        <?php
        $query = "SELECT * FROM order_table WHERE status = 'completed'"; // Filter by status
